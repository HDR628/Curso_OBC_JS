...
function App() {
  ...
  return (
    <>
      ...
      {/* Utilização do retorno implicito da arrow funciton () ao inves de {} -> return() */}
      {games.map((game) => (
        <div  
        style={{ display: "flex", flexWrap: "wrap", gap: "4rem" }} 
        key={game.id}> {/* Muito importante ao usar o map ter uma key para cada elemento percorrido */}
          <img 
          src={game.coverImage}
          alt=""
