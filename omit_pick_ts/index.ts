/* Omit - e um tipo generico, criar novos tipo a partir de existentes no entanto omitindo*/
...
// repo.owner.name = "Henrique" Não da certo pois a info foi omitida no githubRepoResponse


/* Pick, escolher propriedades especificas(quais queremos) */

type LocalGithubUser = Pick<GithubUserResponse, "id" | "login" | "name">

type LocalGithubRepo = Pick<GithubRepoResponse, "id" | "fork" | "stargazers_count" >
